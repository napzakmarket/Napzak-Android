...
fun ProductPresignedUrlResponse.toPresignedUrlMap() = PresignedUrlMap(presignedUrls)

fun ProfilePresignedUrlResponse.toPresignedUrlMap() = PresignedUrlMap(presignedUrls)
